    ...
    <main className="flex min-h-screen items-center justify-center bg-slate-950 px-6 py-12 text-slate-100">
      <div className="w-full max-w-6xl overflow-hidden rounded-[2rem] border border-white/10 bg-slate-900/80 shadow-[0_30px_80px_rgba(2,6,23,0.75)] backdrop-blur-xl">
        <div className="grid min-h-[760px] lg:grid-cols-[1.1fr_0.9fr]">
          <section className="relative hidden overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950/50 p-10 lg:flex lg:flex-col lg:justify-between">
            <div className="absolute inset-0 opacity-30">
              <div className="absolute -left-10 top-16 h-56 w-56 rounded-full bg-emerald-500/20 blur-3xl" />
            ...
            <div className="w-full max-w-md">
              ...
              <form className="space-y-5">
                <div>
                  ...
                  <div className="flex items-center gap-3 rounded-2xl border border-slate-700 bg-slate-900/80 px-4 py-3.5 focus-within:border-emerald-400/60">
                ...
                <a
                  href="/admin"
                  className="flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-emerald-300 via-emerald-400 to-cyan-500 px-5 py-3.5 font-semibold text-slate-950 shadow-[0_20px_40px_rgba(52,211,153,0.2)] transition hover:translate-y-[-1px]"
                >
                  Entrar
