...
const companies = [
  {
    ...
    cardTone: "bg-blue-100 text-blue-700",
  },
  {
    name: "Nexa Logistics",
    nif: "941234890",
    ...
    cardTone: "bg-amber-100 text-amber-700",
  },
  {
    name: "Solaris Group",
    nif: "512347890",
    ...
    cardTone: "bg-emerald-100 text-emerald-700",
  },
  {
    name: "Bengo Energy",
    nif: "700456987",
    ...
    cardTone: "bg-slate-200 text-slate-700",
  },
];
          ...
          {companies.map((company) => (
            ...
            >
              ...
              <div className="flex items-center">
                <span className={`rounded-full px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] ${company.cardTone}`}>
                  {company.status}
                </span>
              </div>
